...
export default function TestBackendPage() {
  const [backendUrl, setBackendUrl] = useState(process.env.NEXT_PUBLIC_AI_BACKEND_URL || 'http://localhost:8000');
  ...
  const [signalingUrl, setSignalingUrl] = useState(process.env.NEXT_PUBLIC_AI_BACKEND_WS_URL || 'ws://localhost:8000');
