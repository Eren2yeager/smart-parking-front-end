  ...
  try {
    ...
    if (!settings) {
      const defaultSettings = {
        ...
        pythonBackend: {
          httpUrl: process.env.NEXT_PUBLIC_PYTHON_BACKEND_URL || process.env.NEXT_PUBLIC_PYTHON_BACKEND_URL || 'http://localhost:8000',
          wsUrl: process.env.NEXT_PUBLIC_PYTHON_BACKEND_URL || process.env.NEXT_PUBLIC_PYTHON_BACKEND_URL || 'ws://localhost:8000',
        },
        cameras: {
          gateFrameSkip: 2,
          lotFrameSkip: 5,
